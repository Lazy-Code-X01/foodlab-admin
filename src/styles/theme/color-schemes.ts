...
import { california, kepple, nevada, redOrange, shakespeare, stormGrey } from './colors';
...
export const colorSchemes = {
  dark: {
    palette: {
      ...
      neutral: { ...nevada },
      primary: {
        light: '#3A5ED4', // Slightly lighter shade of #1341CB
        main: '#1341CB', // Primary color
        dark: '#0E3499', // Slightly darker shade of #1341CB
        contrastText: 'var(--mui-palette-common-black)',
      },
      secondary: {
        ...nevada,
